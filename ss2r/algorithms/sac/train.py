...
from brax.training import acting, replay_buffers
...
def train(
    ...
    alpha_loss, critic_loss, actor_loss = sac_losses.make_losses(
        ...
        safety_discounting=discounting,
        action_size=action_size,
        use_bro=False,
        cost_scaling=0.0,
        init_alpha=None,
    ...
    alpha_update = (
        gradients.gradient_update_fn(  # pytype: disable=wrong-arg-types  # jax-ndarray
            alpha_loss, alpha_optimizer, None
        )
    )
    critic_update = (
        gradients.gradient_update_fn(  # pytype: disable=wrong-arg-types  # jax-ndarray
            critic_loss, q_optimizer, None
        )
    )
    actor_update = (
        gradients.gradient_update_fn(  # pytype: disable=wrong-arg-types  # jax-ndarray
            actor_loss, policy_optimizer, None, has_aux=True
        )
    )
