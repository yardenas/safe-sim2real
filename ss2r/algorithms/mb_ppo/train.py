...
def train(
    ...
    def training_epoch(
        ...
        return training_state, state, loss_metrics, model_loss_metrics
    ...
    def training_epoch_with_timing(
        ...
        training_state, env_state, metrics, model_metrics = _strip_weak_type(result)
    ...
    for it in range(num_evals_after_init):
        ...
        for _ in range(max(num_resets_per_eval, 1)):
            ...
            (training_state, env_state, training_metrics, model_trainig_metrics) = training_epoch_with_timing(
