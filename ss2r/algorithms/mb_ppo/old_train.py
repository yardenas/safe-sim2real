...
def _init_training_state(
    ...
    obs_size: int,
    action_size: int,
    mbppo_network: mb_ppo_networks.MBPPONetworks,
    ...
    model_params = mbppo_network.model_network.init(key_model, obs_size, action_size)
    policy_params = mbppo_network.policy_network.init(key_policy)
    value_params = mbppo_network.value_network.init(key_value)
    cost_value_params = mbppo_network.cost_value_network.init(key_value)
