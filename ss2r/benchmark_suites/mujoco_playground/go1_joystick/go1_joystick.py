...
def domain_randomization(sys, rng, cfg):
    ...
    def rand_dynamics(rng):
        ...
        rng, key = jax.random.split(rng)
        dpos = jax.random.uniform(key, (3,), minval=cfg.jitter_mass[0], maxval=cfg.jitter_mass[0])
        ...
        dmass = jax.random.uniform(
            key, shape=(model.nbody,), minval=cfg.scale_link_mass[0], maxval=cfg.scale_link_mass[1]
        )
